...
/*
Use mkvmerge to mux the DoVi HEVC stream and the original mkv file into the final mkv file with the
transcoded video stream and all the original audio and subtitles
*/

var details = function () {
  return {
    name: 'Mux DoVi Mkv',
    description: 'Mux using mkvmerge with DoVi HEVC stream with original mkv file into mkv file',
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          outFileName = (0, fileUtils_1.getFileName)(args.originalLibraryFile._id) + ".mkv";
          ...
          spawnArgs = [
            ...
            '-D', args.originalLibraryFile._id
          ];
